...
})({"aYBRU":[function(require,module,exports,__globalThis) {
...
var _ownRedux = require("./ownRedux");
...
function reducer(state = InitialState, action) {
    switch(action.type){
        ...
        case INCREMENT_BY:
            return {
                ...state,
                post: state.post + (action.payload || 0)
            };
        case DECREMENT_BY:
            return {
                ...state,
...
const store = (0, _redux.createStore)(reducer, composeEnhancers);
console.log(store.getState());
// store.subscribe(() => {
//     console.log(store.getState());
// });
...
store.dispatch({
    type: INCREMENT_BY,
    payload: 10
}); // Increment post by 10
store.dispatch({
    type: DECREMENT_BY,
    payload: 20
}); // Decrement post by 20
...
},{"redux":"anWnS","./ownRedux":"6PPt6"}],"anWnS":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dYxNV"}],"dYxNV":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dYxNV"}]},["aYBRU","6rimH"], "6rimH", "parcelRequire94c2")
